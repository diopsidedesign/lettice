...
## getting started
copy / paste the code into your favorite es6 javascript web project, or try it in codepen and experiment yourself. its just ~ 100 lines of javascript, no frameworks / dependencies required. just a browser that supports es6 javascript and web components (...chrome).

lettice takes an input object and generates a custom es6 class extending HTML element which defines a new custom element

if you're familiar with frameworks like angular or polymer, the approach and syntax shouldn't be unfamiliar
